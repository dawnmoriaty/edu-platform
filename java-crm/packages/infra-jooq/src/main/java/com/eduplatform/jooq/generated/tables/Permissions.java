...
public class Permissions extends TableImpl<PermissionsRecord> {
     ...
     */
    public final TableField<PermissionsRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "", new AutoConverter<LocalDateTime, LocalDateTime>(LocalDateTime.class, LocalDateTime.class));

    /**
     * The column <code>public.permissions.updated_at</code>.
     */
    public final TableField<PermissionsRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "", new AutoConverter<LocalDateTime, LocalDateTime>(LocalDateTime.class, LocalDateTime.class));
