 ...
 */
package com.eduplatform.jooq.generated.tables;


import com.eduplatform.jooq.generated.Indexes;
import com.eduplatform.jooq.generated.Keys;
import com.eduplatform.jooq.generated.Public;
import com.eduplatform.jooq.generated.tables.Permissions.PermissionsPath;
import com.eduplatform.jooq.generated.tables.RolePermissions.RolePermissionsPath;
import com.eduplatform.jooq.generated.tables.UserRoles.UserRolesPath;
import com.eduplatform.jooq.generated.tables.Users.UsersPath;
...
public class Roles extends TableImpl<RolesRecord> {
     ...
     */
    public final TableField<RolesRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "", new AutoConverter<LocalDateTime, LocalDateTime>(LocalDateTime.class, LocalDateTime.class));

    /**
     * The column <code>public.roles.updated_at</code>.
     */
    public final TableField<RolesRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "", new AutoConverter<LocalDateTime, LocalDateTime>(LocalDateTime.class, LocalDateTime.class));

    /**
     * The column <code>public.roles.code</code>.
     */
    public final TableField<RolesRecord, String> CODE = createField(DSL.name("code"), SQLDataType.VARCHAR(50).nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_ROLES_CODE);
    }
    ...
    public List<UniqueKey<RolesRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.ROLES_CODE_KEY, Keys.ROLES_NAME_KEY);
    }
