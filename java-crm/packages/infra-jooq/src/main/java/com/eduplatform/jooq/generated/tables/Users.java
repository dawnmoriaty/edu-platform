...
import com.eduplatform.jooq.generated.tables.Roles.RolesPath;
...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, String> STATUS = createField(DSL.name("status"), SQLDataType.VARCHAR(50).defaultValue(DSL.field(DSL.raw("'ACTIVE'::character varying"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>public.users.created_at</code>.
     */
    public final TableField<UsersRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "", new AutoConverter<LocalDateTime, LocalDateTime>(LocalDateTime.class, LocalDateTime.class));

    /**
     * The column <code>public.users.updated_at</code>.
     */
    public final TableField<UsersRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "", new AutoConverter<LocalDateTime, LocalDateTime>(LocalDateTime.class, LocalDateTime.class));
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_USERS_EMAIL, Indexes.IDX_USERS_STATUS, Indexes.IDX_USERS_USERNAME);
    }
