...
public class UserRoles extends TableImpl<UserRolesRecord> {
     ...
     */
    public final TableField<UserRolesRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "", new AutoConverter<LocalDateTime, LocalDateTime>(LocalDateTime.class, LocalDateTime.class));
